...
export function SeeTypoDe(
  ...
  return <div style="text-align:right; margin-top:64px;"><span class="icon-font" data-ignore-text="" style="vertical-align: sub">create</span><a href={href}>BERICHTIGE FEHLER</a></div>
